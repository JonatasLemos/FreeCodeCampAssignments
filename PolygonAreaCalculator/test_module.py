...
from FreeCodeCampProjects.PolygonAreaCalculator import AreaCalculator

class UnitTests(unittest.TestCase):
    def setUp(self):
        self.rect = AreaCalculator.Rectangle(3, 6)
        self.sq = AreaCalculator.Square(5)

    def test_subclass(self):
        actual = issubclass(AreaCalculator.Square, AreaCalculator.Rectangle)
        expected = True
        self.assertEqual(actual, expected, 'Expected Square class to be a subclass of the Rectangle class.')

    def test_distinct_classes(self):
        actual = AreaCalculator.Square is not AreaCalculator.Rectangle
        expected = True
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, AreaCalculator.Square) and isinstance(self.sq, AreaCalculator.Rectangle)
        expected = True
    ...
    def test_get_amount_inside_two_rectangles(self):
        rect2 = AreaCalculator.Rectangle(4, 8)
    ...
    def test_get_amount_inside_none(self):
        rect2 = AreaCalculator.Rectangle(2, 3)
        actual = rect2.get_amount_inside(self.rect)
        expected = 0
